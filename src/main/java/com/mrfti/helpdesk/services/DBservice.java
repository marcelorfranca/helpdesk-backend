...
public class DBservice {
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Marcelo Ramos", "753.988.110-02", "marcelo@mrftio.com", encoder.encode("123"));
		...
		Cliente cli1 = new Cliente(null, "Bill Gates", "655.844.770-36", "bill@mrfti.com", encoder.encode("111"));
